# Generated by Powerlevel10k configuration wizard on 2021-04-13 at 20:53 CEST.
...
() {
  ...
  #typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
  #    '*prod1*'  PROD    # These values are examples that are unlikely
  #    # '*test*'  TEST    # to match your needs. Customize them as needed.
  #    '*'       DEFAULT)
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
    '*prod*'  PROD    # These values are examples that are unlikely
    '*int*'  INT    # These values are examples that are unlikely
    '*'       DEFAULT)
 
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=40
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=0
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_KUBECONTEXT_NAME}}'
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+=' '
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/default}'
  #POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='$(kubectx -c)'
  #POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='$(kubectl config view --minify --output 'jsonpath={..namespace}'; echo)'

  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_FOREGROUND=196
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_BACKGROUND=242
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_PROD_EXPANSION+='${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_KUBECONTEXT_NAME}}'
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_PROD_EXPANSION+=' '
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_PROD_EXPANSION+='${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/default}'

  typeset -g POWERLEVEL9K_KUBECONTEXT_INT_FOREGROUND=33
  typeset -g POWERLEVEL9K_KUBECONTEXT_INT_BACKGROUND=0
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_INT_EXPANSION+='${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_KUBECONTEXT_NAME}}'
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_INT_EXPANSION+=' '
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_INT_EXPANSION+='${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/default}'
